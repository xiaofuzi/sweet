...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log('component: ', _Component2.default);
	...
	// console.log('isComponent: ', isComponent(SubComponent));
	function isComponent(component) {
	    return component instanceof _Component2.default ? true : false;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utils = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./utils.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Component = function () {
	    ...
	    _createClass(Component, [{
	        ...
	        value: function renderDOM() {
	            this.$vTree = this.render(this._h);
	        }
	    }, {
	        key: '_update',
...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log('component01: ', _Component2.default);
	...
	function renderHelper() {
	    ...
	    if ((0, _utils.isComponent)(rest[0])) {
	        var child = rest[0];
	
	        return child.renderDOM();
	    } else {
	        return (0, _virtualDom.h)(rest);
	    }
	}
	
	exports.default = {
	    VNode: _virtualDom.VNode,
	    VText: _virtualDom.VText,
